...
Examples/DllExport/BasicExport/DllExport.bat
@3F
3F .NET DllExport up to 1.7.1
Latest commit 93618dc on May 9
History
1 contributor
502 lines (502 sloc) 19.7 KB
@echo off
...
:bq
echo.
@echo .NET DllExport v1.7.1.6918+61defd6
...
@echo v1.7.1.6918+61defd6  %__dxp_pv%
goto bu
